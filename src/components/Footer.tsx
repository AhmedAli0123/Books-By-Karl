...
<footer className="bg-[#141316] border-t border-black">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div className="text-gray-500 dark:text-gray-400 font-medium">
                  <h2 className="mb-4 ">The Author</h2>
                  <ul >
                      <li className="mb-4">
                      ...
                      <li>
                          <Link href="" className="hover:underline">Contect</Link>
                      </li>
                  </ul>
              </div>
              ...
              <div className="text-gray-500 dark:text-gray-400 font-medium">
                  ...
                  <ul >
                      ...
                      <li>
                          <Link href="" className="hover:underline">All Works</Link>
                      </li>
                  </ul>
              </div>
              ...
              <div className="text-gray-500 dark:text-gray-400 font-medium">
                  <h2 className='mb-4'>Upcomming</h2>
                  <ul >
                      <li className="mb-4">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© {new Date().getFullYear()} <Link href="" className="hover:underline">BOOKS BY KARL™</Link>. All Rights Reserved.
          </span>
