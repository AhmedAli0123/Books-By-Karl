...
const BookSection = () => {
  return (
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 mt-20 bg-black">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10  p-6 rounded-xl shadow-lg">
        ...
        <div className="w-full md:w-[40%] flex justify-center">
          <div className="w-[250px] sm:w-[270px] h-auto">
            <Image
              src={book1}
              alt="Book Cover"
              width={270}
